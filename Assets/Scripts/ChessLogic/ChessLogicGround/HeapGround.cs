...
/// <summary>
/// HeapGround for sorting moves. Move with the highest eval is kept at the top
/// </summary>
public class HeapGround {
	...
	public HeapGround(int maxHeapSize) {
...
public interface IHeapItemGround<T> : IComparable<T> {
	int HeapIndex {
		get;
		set;
	}
