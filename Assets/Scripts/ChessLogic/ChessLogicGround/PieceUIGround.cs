...
/*
 * The PieceUIGround script is attached to all squares of the board
 ...
 * In order to actually make a move on the board, the ChessUIGround class must be used.
 * 
 * The objects to which the PieceUIGround scripts are attached all have the 'Piece' layer assigned.
 * The 'Piece' layer will be disabled while being moves so as not to interfere with input.
 */

public class PieceUIGround : MonoBehaviour {
