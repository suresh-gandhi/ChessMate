...
public class ChessUIOld : MonoBehaviour {               // CHANGED IN ORIGINAL
	...
	static ChessUIOld myInstance;                       // CHANGED IN OLD
	...
	/// Gets the instance.
	/// </summary>
	public static ChessUIOld instance                   // CHANGED IN OLD
    {       
        get {
			if (myInstance == null) {
				myInstance = FindObjectOfType<ChessUIOld> ();       // CHANGED IN OLD
            }
			return myInstance;
		}
	}
